...
DataInfo.condition(1,:) =[6000;67;29;95];
DataInfo.condition(2,:) =[6500;67;29;95];
DataInfo.condition(3,:) =[7000;67;25;95];
DataInfo.condition(4,:) =[7500;67;25+1/3;95];
DataInfo.condition(5,:) =[8000;67;25+1/3*2;95];
DataInfo.condition(6,:) =[8500;67;25+1/3*3;95];
DataInfo.condition(7,:) =[9000;67;25+1/3*4;95];
DataInfo.condition(8,:) =[9500;67;25+1/3*5;95];
DataInfo.condition(9,:) =[10000;67;25+1/3*6;95];
DataInfo.condition(10,:)=[10500;67;25+1/3*7;95];
DataInfo.condition(11,:)=[11000;67;25+1/3*8;95];
DataInfo.condition(12,:)=[11500;67;25+1/3*9;95];
DataInfo.condition(13,:)=[12000;67;25+1/3*10;95];
DataInfo.condition(14,:)=[12500;67;25+1/3*11;95];
DataInfo.condition(15,:)=[13000;67;29;95];
...
for i_rotorspeed=13 %固定一个转速
    ...
    for  i_file=DataInfo.condition(i_rotorspeed,2)
        amplitude_freq_dB=(amplitude_freq{i_rotorspeed,i_file}(:,sensorLabel));
