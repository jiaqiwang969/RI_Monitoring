...
%     ylim([-1 101]);
    ...
    %
    subplot('position',[0.1 0.11 0.36 0.8])
...
%     plot(UI_FFT(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),3),'LineWidth',2,'Color','b')
    plot(UI_FFT_stftAverage(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),2),'+-','LineWidth',2,'Color','g')
        hold on
...
%     plot(1/2400*UI_FFT_waveletAverage(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),1),'+-','LineWidth',2,'Color','r')
    ...
    % 设置其余坐标区属性
    title('FFT频带能量E_{RI}','FontSize',14)
    set(gca,'FontSize',14);

    RIband=[8:22]

        subplot('position',[0.5 0.11 0.36 0.8])
%     plot(UI_FFT(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),10),'LineWidth',2,'Color','k')
%     plot(UI_FFT(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),9),'LineWidth',2,'Color',[0.6350 0.0780 0.1840])
%     plot(UI_FFT(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),8),'LineWidth',2,'Color',[0.4940 0.1840 0.5560])
%     plot(UI_FFT(i_rotorspeed,1:DataInfo.condition(i_rotorspeed,2),7),'LineWidth',2,'Color',[0.3010 0.7450 0.9330])
...
saveas(h1,[save_directory,'/','FIG02-B1vsRIEri-',num2str(DataInfo.condition(i_rotorspeed,1)),'rpm','-采样率',num2str(resamplePoint),'-RIband-',num2str(RIband(1)),'-',num2str(RIband(end))],'eps')
saveas(h1,[save_directory,'/','FIG02-B1vsRIEri-',num2str(DataInfo.condition(i_rotorspeed,1)),'rpm','-采样率',num2str(resamplePoint),'-RIband-',num2str(RIband(1)),'-',num2str(RIband(end))],'fig')
saveas(h1,[save_directory,'/','FIG02-B1vsRIEri-',num2str(DataInfo.condition(i_rotorspeed,1)),'rpm','-采样率',num2str(resamplePoint),'-RIband-',num2str(RIband(1)),'-',num2str(RIband(end))],'pdf')
