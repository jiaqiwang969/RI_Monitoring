...
p_7000 = polyfit(FAMEN(3,xuhao_7000_fit),UI_FFT_noAverage(3,xuhao_7000_fit,2),5);
...
for k=3:15
    RS1=DataInfo.condition(k,1);
    xuhao=find(FAMEN(k,:)<famen_range(1) & FAMEN(k,:)>famen_range(2));
    plot(FAMEN(k,xuhao),(UI_FFT_noAverage(k,xuhao,2)-Iri_1_real(RS1,70))/max_13000_35*xishu,'Color',jet_color(k-3+1,:),'LineWidth',2)
    hold on
