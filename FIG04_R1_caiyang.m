...
subplot('position',[0.1 0.11 0.39 0.8])
...
% for N_caiyang=1:4 %固定一个转速
    ...
    txt = {...
        ['转速',num2str(DataInfo.condition(i_rotorspeed,1))], ['位置',DataInfo.sensorArray{2}]};
    annotation('textbox',...
        [0.2 0.77 0.17 0.13],...
        'String',txt,...
        'FontSize',20,...
...
set(gca,'FontSize',20);
    legend1 = legend('1*29','2*29','3*29','4*29','5*29','6*29','7*29')
...
set(gca,'FontSize',20,'YGrid','on','YTick',[700 900 1100 1300 1500 1700 1900],...
    'YTickLabel',{'1*29','2*29','3*29','4*29','5*29','6*29','7*29'});
